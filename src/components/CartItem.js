...
const CartItem = ({ item }) => {
    const { removeFromCart, increseAmount, decreseAmount } = useContext(CartContext);
    const { id, title, image, price, amount } = item;
    console.log(item);
    return (
        <div className="fle gap-x-4 py-2 lg:px-6 border-b border-gray-200 w-full font-light text-gray-500">
